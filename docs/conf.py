...
project = u'puppet-php - PHP module for Puppet'
...
man_pages = [
    ('index', 'puppet-php', u'puppet-php Documentation',
...
texinfo_documents = [
  ('index', 'puppet-php', u'puppet-php Documentation',
   u'Christian Winther', 'puppet-php', 'One line description of project.',
   'Miscellaneous'),
]
